...
import (
	...
	"net/http"
	"strings"
	"vault-auth-plugin/bh/bastion_host"
...
func Signin(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		fmt.Println("Error in bastion host authentication")
		http.Error(w, err.Error(), http.StatusBadRequest)
		return
	}
	...
	if err != nil {
		fmt.Println("Error in user authentication")
		http.Error(w, err.Error(), http.StatusBadRequest)
		return
	}
	...
	if err != nil {
		fmt.Println("Error in getting the SSH OTP")
		http.Error(w, err.Error(), http.StatusBadRequest)
		return
	}
